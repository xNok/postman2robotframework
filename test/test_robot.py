...
def collection(tmpdir, request):
    ...
    resources_robot = os.path.join(resources, test_name + ".robot")
    ...
    copyfile(resources_robot, os.path.join(tmpdir, "test.robot"))
...
class Test_Postman2Robot:
    ...
    def test_simple(self, tmpdir, collection):
        ...
        print(subprocess.check_output(['robot','test.robot']))
